...
public class ProductHandler implements Runnable {
    ...
    private Hashtable aHashtable2089 = new Hashtable();
    private static final String[] aStringArray2090 = new String[2];
    ...
    public void run() {
        while (true) {
            Tools.sleep(5000L);
            Enumeration var2 = this.aHashtable2089.elements();
    ...
    public void addProduct(Product var1) {
        this.aHashtable2089.put(var1.getProductName().toLowerCase(), var1);
    }

    public Product getProduct(String var1) {
        return var1 == null ? null : (Product) ((Product) this.aHashtable2089.get(var1.toLowerCase()));
    }

    public Product[] getMultipleProducts(String var1) {
        String var2 = var1.toLowerCase();
        Product var3 = (Product) ((Product) this.aHashtable2089.get(var2));
        if (var3 == null) {
            return null;
        } else {
            ...
            var2 = var2 + "__";
            Enumeration var5 = this.aHashtable2089.elements();
    ...
    public boolean userHaveAnyProduct(String var1) {
        String var2 = var1.toLowerCase();
        Enumeration var4 = this.aHashtable2089.elements();
    ...
    static {
        aStringArray2090[0] = "ProductHandler: Unknown version of productdata!";
        aStringArray2090[1] = "__";
    }
}
