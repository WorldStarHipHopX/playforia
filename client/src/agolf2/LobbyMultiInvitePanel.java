...
class LobbyMultiInvitePanel extends IPanel implements ActionListener, ItemListener {
    ...
    protected LobbyMultiInvitePanel(Class58_Sub1 var1, LobbyMultiContentPanel var2, int var3, int var4) {
